...
      l_pass = st.text_input("পাসওয়ার্ড", type="password", key="l_pass")
...
      s_pass = st.text_input("নতুন পাসওয়ার্ড", type="password", key="s_pass")
...
        sensor_prompt = f"রোগীর তাপমাত্রা: {temp} °F, হার্ট রেট: {heart_rate}, SpO2: {spo2}%। বাংলায় একটি বিস্তারিত স্বাস্থ্য রিপোর্ট তৈরি করুন।"
